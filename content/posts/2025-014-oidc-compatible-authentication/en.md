...
seo_description = "Feeds Fun now supports authentication via external services, making multi-user self-hosting easier."
seo_image = "./cover.jpg"
---
...
We moved away from Supertokens-locked approach because it was too restrictive and not very convenient.

That means Feeds Fun should be much easier to selfhost in multi-user mode. Simply put, you need just to pass two headers from your authentication proxy to Feeds Fun backend — and you are good to go.
...
However, any popular authentication solution should work fine, as long as it can pass the required headers to Feeds Fun backend and return 401 for unauthenticated requests to the frontend.
